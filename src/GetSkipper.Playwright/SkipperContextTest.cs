...
/// <summary>
/// Drop-in replacement for <see cref="ContextTest"/> that checks Skipper before
/// Playwright creates the browser context.
/// </summary>
public abstract class SkipperContextTest : ContextTest
{
    [SetUp]
